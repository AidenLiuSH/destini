...
class StoryBrain {
  ...
  //Progress to the next story, takes in choice made by user
  ...
  //restart the story number to 0 if curr story number is 3,4 or 5.
  void restart() {
    _storyNumber = 0;
  }

  //Button only visible of story number is 0,1 or 2
  bool buttonVisible() {
